...
const Users = () => {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      setUsers(res.data.users.filter((user)=> user.isAdmin !== true));
  ...
  const creditBalance = filteredUsers.reduce((acc, user) => acc + (user.balance && user.type === "credit"), 0);
  const debitBalance = filteredUsers.reduce((acc, user) => acc + (user.balance && user.type === "debit"), 0);
...
//                     <TableCell className="text-white font-medium text-center">Actions</TableCell>
//                   </TableRow>
//                 </TableHead>
//                 <TableBody>
//                   {filteredUsers.length > 0 ? (
