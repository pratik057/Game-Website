        ...
        <DialogContent className="pt-6 px-6">
          <div className="space-y-5">
            ...
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-100 mb-6">
              <Typography variant="subtitle2" className="text-blue-700 mb-2 font-medium">
                User Information
              </Typography>
              ...
              <TextField
                ...
                helperText="Enter the display name for this user"
              />
              ...
              <TextField
                ...
                helperText="User's contact mobileNo number"
              />
            </div>
