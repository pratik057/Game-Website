...
const GameUI = () => {
  ...
  <div className="bg-[#0c1228] rounded-lg shadow-2xl p-8 w-full max-w-md flex flex-col items-center">
    ...
    {/* New Game Button with Gradient Hover Effect */}
    <button className="w-64 h-14 mb-8 relative overflow-hidden rounded-md group">
    ...
    {/* Deposit Button */}
    <button className="w-64 text-white bg-gray-800 hover:bg-amber-300 hover:text-black rounded-md transition-colors duration-300 py-3 text-xl mb-4">
      Deposit
    </button>

    {/* Withdraw Button */}
    <button className="w-64 text-white bg-gray-800 hover:bg-gray-700 hover:text-amber-300 rounded-md transition-colors duration-300 py-3 text-xl mb-4">
      Withdraw
    </button>

    {/* Exit Game Button */}
    <button className="w-64 text-white bg-gray-800 hover:bg-red-500 hover:text-white rounded-md transition-colors duration-300 py-3 text-xl">
      Exit Game
    </button>
