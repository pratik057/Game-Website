...
export default function LoginScreen() {
  return (
    ...
    >
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 justify-between top-0">
        ...
        <div className="w-full flex justify-center items-end pt-10 md:pt-0.5 relative ">
          <img
            src={woman}
            alt="Model"
            className="h-[80%] object-cover sm:bottom-0"
          />
        </div>
      </div>
    </div>
