...
const WalletControls = () => {
  ...
  return (
    <div className="h-screen w-full flex flex-col items-center justify-center bg-gray-900 p-6">
    <div className="w-full max-w-5xl bg-gradient-to-br from-gray-800 to-gray-700 p-8 rounded-2xl shadow-2xl text-white border border-gray-700 flex flex-col lg:flex-row gap-6">
      
      {/* Wallet Balance Section */}
      <div className="w-full lg:w-1/3 flex flex-col items-center text-center bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-700">
        ...
        <div className="flex w-full bg-gray-700/50 rounded-lg p-1">
          <button
            className={`flex-1 py-3 rounded-md flex items-center justify-center gap-2 transition-all duration-300 ${
        ...
        <motion.input
          type="number"
          className="w-full p-3 mt-4 rounded-lg bg-gray-700/50 border border-gray-600 text-white focus:ring-2 focus:ring-blue-500"
      ...
      <div className="w-full lg:w-2/3 bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-700">
              ...
              <tbody>
                {transactions.map((txn, index) => (
                  <tr key={index} className="border-b border-gray-700 hover:bg-gray-700/50 transition-all">
                    <td className={`px-4 py-2 ${txn.type === "credit" ? "text-green-400" : "text-red-400"}`}>
